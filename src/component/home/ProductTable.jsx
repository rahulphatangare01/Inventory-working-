    ...
    sx={{ maxHeight: '300px'}} >
        ...
        <Table aria-label='simple table' stickyHeader>
            ...
            <TableCell align='center' > 
                         <EditIcon onClick={() => update_btn(ele, index)} sx={{color :"green", margin:"0 4px "}}/>
             <DeleteIcon onClick={() => handle_delete(ele._id)} sx={{color :"red", margin:"0 4px "}}/>
            </TableCell>
            </TableRow>
                   )
               })   
            ...
            <Box sx = {{amrgin:"auto"}}>
              <Grid>
                <Paper elevation={10} sx={style}>
                  <Grid align="center">
                    <CategoryIcon style={avatarStyle} />
